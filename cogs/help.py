import discord, platform, datetime, logging, time, os
...
class Help(commands.Cog):
    ...
    async def help(self, ctx, section=None):
        if section is None:
            ...
            embed.add_field(name=f"`{self.bot.prefix}give`", value="Sell any item for 75% of its value to the shop", inline=False)
            embed.add_field(name=f"`{self.bot.prefix}pay`", value="Sell any item for 75% of its value to the shop", inline=False)
